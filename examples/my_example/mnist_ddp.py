...
def main():
    np.random.seed(42)
    b=np.random.gamma(1, 5.0, 1) +  np.random.exponential(0.5, 1) + np.random.uniform(0, 1, 1)
...
if __name__ == "__main__":
    ...
    sys.argv=[os.path.basename(__file__), "--device=cpu", '-n=200', '--lr=.10', '-c=1.3', '-b=240', '--type-accountant=dma']
