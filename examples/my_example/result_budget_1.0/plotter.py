...
if __name__=="__main__":
    ...
    files= {
        ...
        "0.0": "data_r2dp_dynamic_epoch1000_budget_0.pkl"
    }
    ...
    plot_epsilon_given_budget(data_epsilon, [ 1.0], legends, line_styles)

    plot_accuracy_given_budget(data_epsilon, data_accuracy, [1.0], legends, line_styles)
